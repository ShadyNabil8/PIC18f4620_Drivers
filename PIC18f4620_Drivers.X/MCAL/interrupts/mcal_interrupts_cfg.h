...
#define INTERRUPTS_INTx_ENEBLE 1
#define INTERRUPTS_RBx_ENEBLE 1
#define INTERRUPTS_ADC_ENEBLE 1

/*INT0 is always high*/
#define INTERRUPTS_INT1_HIGH_PRIORITY 0
#define INTERRUPTS_INT2_HIGH_PRIORITY 1
#define INTERRUPTS_RBx_HIGH_PRIORITY 1
